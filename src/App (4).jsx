      ...
      <div style={{ width:"100%", maxWidth:380 }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div>
            ...
            <input value={newPin} onChange={e=>setNewPin(e.target.value.replace(/[^0-9]/g,""))} type="tel" inputMode="numeric" pattern="[0-9]*" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" placeholder="0000" style={{...inpSt, letterSpacing:"0.3em", textAlign:"center", fontSize:22}} />
          </div>
      ...
      <div style={{ width:"100%", maxWidth:380 }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:14 }}>
          ...
          <div>
            ...
            <input value={pin} onChange={e=>setPin(e.target.value.replace(/[^0-9]/g,""))} type="tel" inputMode="numeric" pattern="[0-9]*" autoComplete="off" autoCorrect="off" autoCapitalize="off" spellCheck="false" placeholder="0000" onKeyDown={e=>e.key==="Enter"&&handleLogin()} style={{...inpSt, letterSpacing:"0.3em", textAlign:"center", fontSize:22}} />
          </div>
          {error && <div style={{ fontSize:13, color:error.startsWith("✅")?C.green:C.red, padding:"10px 14px", background:"rgba(0,0,0,0.3)", borderRadius:12 }}>{error}</div>}
